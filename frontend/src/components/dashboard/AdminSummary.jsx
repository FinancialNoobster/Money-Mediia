...
import { FaBuilding, FaBusinessTime, FaCheckCircle, FaFileAlt, FaHourglassHalf, FaHourglassStart, FaMoneyBillWave, FaTimesCircle, FaUsers } from 'react-icons/fa'
  ...
  return (
    <div className='p-6'>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-6'>
        ...
        <SummaryCard icon={<FaMoneyBillWave />} text="Monthly Salary" number="₹45000" color="bg-red-600" />
      </div>
      <div className='mt-12'>
         <h4 className='text-center text-2xl font-bold'>Leave Details</h4>
        <div className='grid grid-cols-1 md:grid-cols-3 gap-4 mt-6'>
        <SummaryCard icon={<FaFileAlt />} text="Leave Applied" number={5} color="bg-teal-600" />
        <SummaryCard icon={<FaCheckCircle />} text="Leave Appproved" number={2} color="bg-green-600" />
